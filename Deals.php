...
#content{
   ...
   img{
	...
	<body>
		<br><br>
		<h2 align="center"><u>MOTOR VEHICLES FOR SALE</u></h2>
		<div id="content">
  <?php
    ...
    ?>
<form method="POST" action="Deals.php" enctype="multipart/form-data">
  	...
  	<div>
		...
		<br><br>
	 <br><br>
	 <p align="center">Buy a Plot of land with us as your trusted agent
	 <br><button class="button" onclick="window.location.href = 'Plots.php';">VIEW PLOTS</button>
		<br><br>
